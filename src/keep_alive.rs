...
pub enum KeepAlive {
    ...
    Object {
        ...
        ///
        /// This implies that [`run_at_load`](crate::LaunchAgent::run_at_load)
        /// is set to `true`, since the job needs to run at least once before
        /// an exit status can be determined.
        successful_exit: Option<bool>,

        #[deprecated(
            note = "This is no longer implemented as it never acted how most users expected."
        )]
        ...
        /// condition.
        ///
        /// The intent of this feature is that two or more jobs may
        /// create semaphores in the file- system namespace. The following
        /// example keeps the job alive as long as the file /path/to/file
        /// exists.
        ///
        /// <div class="warning">
        ///     IMPORTANT: Filesystem monitoring mechanisms are inherently
        ///     race-prone and lossy. This option should be avoided in favor of
        ///     demand-based alternatives using IPC.
        /// </div>
        ...
        ///     whether it is running. Use of this key is highly discouraged.
        ///     If multiple jobs need to coordinate coordinate their
        ///     lifecycles, they should establish contracts using IPC.
        /// </div>
        other_job_enabled: Option<HashMap<String, bool>>,

        /// If `true`, the the job will be restarted as long as it exited due
        /// to a signal which is typically associated with a crash (`SIGILL`,
        /// `SIGSEGV`, etc.). If `false`, the job will be restarted in the
        /// inverse condition.
        crashed: Option<bool>,
    },
}
